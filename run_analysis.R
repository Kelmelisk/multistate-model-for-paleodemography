...
# Extract the PNBF column and convert it to a numeric vector
ill <- as.numeric(data$PNBF)
...
print("Data summary before fitting:")
print(paste("Number of observations:", length(x)))
print(paste("Number with PNBF:", sum(ill)))
print(paste("Age range:", min(x), "to", max(x), "years"))
...
# Create histogram with fitted density overlay
png("age_distribution_fitted2.png", width = 800, height = 600)
...
print(paste("Total number of individuals:", length(x)))
print(paste("Number with PNBF:", sum(ill)))
print(paste("Proportion with PNBF:", sum(ill) / length(ill)))
print(paste("Age range:", min(x), "to", max(x), "years"))
...
# Extract the CO column and convert it to a numeric vector
ill <- as.numeric(data$CO)
...
print("Data summary before fitting:")
print(paste("Number of observations:", length(x)))
print(paste("Number with CO:", sum(ill)))
print(paste("Age range:", min(x), "to", max(x), "years"))
...
# Create histogram with fitted density overlay
png("age_distribution_fitted3.png", width = 800, height = 600)
...
print(paste("Total number of individuals:", length(x)))
print(paste("Number with CO:", sum(ill)))
print(paste("Proportion with CO:", sum(ill) / length(ill)))
print(paste("Age range:", min(x), "to", max(x), "years"))
